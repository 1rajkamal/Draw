    ...
    <>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {roomCode && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-800/80 hover:bg-slate-700/80 border border-white/10 text-xs font-mono text-pink-300 transition-colors"
                title="Click to copy room code"
              >
                <span className="text-slate-400 font-sans hidden xs:inline">Room:</span>
            ...
            <div
              ...
              title={connected ? 'Connected to game server' : 'Reconnecting...'}
            >
            ...
            >
              {isMuted ? <VolumeX size={18} className="text-rose-400" /> : <Volume2 size={18} className="text-cyan-400" />}
            </button>
      ...
      {showRules && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-fadeIn">
          <div className="glass-panel w-full max-w-lg p-6 sm:p-8 relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="mt-5 space-y-4 text-sm text-slate-300 leading-relaxed">
              <div className="flex gap-3 items-start p-3 rounded-xl bg-slate-800/50 border border-white/5">
                ...
                <p><strong className="text-white">Create or Join a Room:</strong> One partner creates a 6-character room and shares the code or QR code with their partner.</p>
              </div>
              ...
              <div className="flex gap-3 items-start p-3 rounded-xl bg-slate-800/50 border border-white/5">
                ...
                <p><strong className="text-white">Select Level & Drawing:</strong> Pick between Easy (120s), Medium (90s), or Hard (60s), then select 1 of 10 cartoon reference images.</p>
              </div>
              ...
              <div className="flex gap-3 items-start p-3 rounded-xl bg-slate-800/50 border border-white/5">
                ...
                <p><strong className="text-white">Race & Recreate:</strong> Use pencils, sketch pens, brushes, highlighters, and color swatches to draw the reference before the timer runs out!</p>
              </div>
              ...
              <div className="flex gap-3 items-start p-3 rounded-xl bg-slate-800/50 border border-white/5">
                ...
                <p><strong className="text-white">Automated AI Accuracy Match:</strong> Once both submit, the computer vision engine analyzes edge contours, structural similarity (SSIM), and color harmony to declare the winner!</p>
              </div>
              ...
              <div className="flex gap-3 items-start p-3 rounded-xl bg-slate-800/50 border border-white/5">
                ...
                <p><strong className="text-white">Watch Stroke Replay:</strong> Relive the round stroke-by-stroke with the synchronized time-lapse player and download your match postcard!</p>
              </div>
            </div>
